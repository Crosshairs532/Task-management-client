                        ...
                        <form className=" p-2 space-y-3" onSubmit={handleSubmit(onSubmit)}>
                            <div className=" flex lg:flex-row gap-2 md:flex-row  items-center ">
                                <div>
                                    ...
                                    <br />
                                    <input id="taskname" defaultValue={item?.TaskName} className=" px-2 py-2 rounded-2xl  text-placeholder" placeholder=" Name Your Task..." {...register("TaskName", { required: true })} /> <br />
                                ...
                                <div>
                                    ...
                                    <select defaultValue={item?.priority} className=" rounded-lg  font-Syne py-2 px-2 text-placeholder" {...register("priority", { required: true })}>
                            ...
                            <div className=" pt-5 flex flex-col">
                                <div>
                                    ...
                                    <textarea defaultValue={item?.description} placeholder=" enter description...." name="description" {...register('description', { required: true })} id="" className=" w-full" rows="5"></textarea>
                                    {errors.description && <span className=" text-[red]">This field is required</span>}
                                </div>
                                <input defaultValue={item?.date} type="date" {...register('date', { required: true })} />
                            </div>
